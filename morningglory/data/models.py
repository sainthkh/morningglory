...
from morningglory.wpmigration import WP_PREFIX
...
class WpCommentmeta(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}commentmeta'.format(WP_PREFIX)
...
class WpComments(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}comments'.format(WP_PREFIX)
...
class WpLinks(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}links'.format(WP_PREFIX)
...
class WpOptions(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}options'.format(WP_PREFIX)
...
class WpPostmeta(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}postmeta'.format(WP_PREFIX)
...
class WpPosts(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}posts'.format(WP_PREFIX)
...
class WpTermRelationships(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}term_relationships'.format(WP_PREFIX)
...
class WpTermTaxonomy(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}term_taxonomy'.format(WP_PREFIX)
...
class WpTermmeta(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}termmeta'.format(WP_PREFIX)
...
class WpTerms(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}terms'.format(WP_PREFIX)
...
class WpUsermeta(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}usermeta'.format(WP_PREFIX)
...
class WpUsers(models.Model):
    ...
    class Meta:
        managed = False
        db_table = '{0}users'.format(WP_PREFIX)
